...
use strict;
use warnings;
package Config::Structure::ValidatatorFactory;

=head1 NAME

Config::Structure::ValidatatorFactory - create validators for use in schemas

=head1 SYNOPSIS

 use Config::Structure::ValidatatorFactory;
...
The ValidatorFactory lets you create falidator functions for use in L<Config::Structure> schemas.
